...
import ResumeModalButton from "@/components/resume/resume-modal-button";

import SectionWrapper from "../ui/section-wrapper";

type HeroSectionProps = {
  primaryResumeAvailable: boolean;
  secondaryResumeAvailable: boolean;
};

const HeroSection = ({
  primaryResumeAvailable,
  secondaryResumeAvailable,
}: HeroSectionProps) => {
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-6 flex flex-col gap-2 w-fit">
                <BoxReveal delay={2} width="100%">
                  <ResumeModalButton
                    primaryAvailable={primaryResumeAvailable}
                    secondaryAvailable={secondaryResumeAvailable}
                  />
                </BoxReveal>
